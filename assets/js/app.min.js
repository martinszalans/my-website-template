...
!(function (e, t) {
  ...
  var n,
    ...
    d = function (e) {
      ...
      return n || r
        ? ((i = i.split(",")[0]),
          (s = s.split(",")[0]),
          1e3 * (Number.parseFloat(i) + Number.parseFloat(s)))
        : 0;
    },
    u = function (e) {
        ...
        var h = A(o, t.replace(E, "")),
          p = a
            ? (function (e, t, i) {
                return function s(n) {
                  for (
                    var r = e.querySelectorAll(t), a = n.target;
                    a && a !== this;
                    a = a.parentNode
                  )
  ...
  var Y = {
    ...
    X = {
      ...
      parents: function (e, t) {
        for (
          ...
          this.matches(s, t) && i.push(s), (s = s.parentNode);
        return i;
      },
      prev: function (e, t) {
    ...
    Q = (function (e) {
      function n(t, i) {
        var s;
        return (
          ((s = e.call(this, t) || this)._items = null),
          (s._interval = null),
          (s._activeElement = null),
          (s._isPaused = !1),
          (s._isSliding = !1),
          (s.touchTimeout = null),
          (s.touchStartX = 0),
          (s.touchDeltaX = 0),
          (s._config = s._getConfig(i)),
          (s._indicatorsElement = X.findOne(
            ".carousel-indicators",
            s._element
          )),
          (s._touchSupported =
          ...
          (s._pointerEvent = Boolean(window.PointerEvent)),
      ...
      return (
        ...
        (r._getItemByDirection = function (e, t) {
          ...
          if (((s && 0 === n) || (i && n === r)) && !this._config.wrap)
            return t;
          ...
          if (
            ...
            if (
              ...
              N.one(a, "transitionend", function () {
                l.classList.remove(i, s),
                  l.classList.add("active"),
                  a.classList.remove("active", s, i),
                  (r._isSliding = !1),
                  setTimeout(function () {
        ...
        (n.dataApiClickHandler = function (e) {
          ...
          if (t && t.classList.contains("carousel")) {
            ...
            r && (s.interval = !1),
              n.carouselInterface(t, s),
              r && T(t, "bs.carousel").to(r),
              e.preventDefault();
          }
        }),
        t(n, null, [
  ...
  var K = "collapse",
    ...
    ee = (function (e) {
      function n(t, i) {
        var s;
        ((s = e.call(this, t) || this)._isTransitioning = !1),
          (s._config = s._getConfig(i)),
          (s._triggerArray = X.find(
        ...
        for (
          var n = X.find('[data-bs-toggle="collapse"]'), r = 0, a = n.length;
          r < a;
          r++
        ) {
          var o = n[r],
          ...
          null !== c &&
            d.length &&
            ((s._selector = c), s._triggerArray.push(o));
        }
        return (
          (s._parent = s._config.parent ? s._getParent() : null),
          s._config.parent ||
            s._addAriaAndCollapsedClass(s._element, s._triggerArray),
          s._config.toggle && s.toggle(),
          s
        );
      }
      s(n, e);
        ...
        (r.show = function () {
          ...
          if (
            ...
            if (t) {
              ...
              if ((i = r ? T(r, "bs.collapse") : null) && i._isTransitioning)
                return;
            }
            if (
              ...
              t &&
                t.forEach(function (e) {
                  s !== e && n.collapseInterface(e, "hide"),
      ...
      X.find(i).forEach(function (e) {
        ...
        s
          ? (null === s._parent &&
              ...
              ((s._config.parent = t.parent), (s._parent = s._getParent())),
            (i = "toggle"))
          : (i = t),
  ...
  function xe(e) {
    for (var t = de(e), i = we(e); i && _e(i) && "static" === ve(i).position; )
      i = we(i);
  ...
  function ke(e) {
    var t,
      ...
      c = (function (e) {
        ...
        return { x: Math.round(t * s) / s || 0, y: Math.round(i * s) / s || 0 };
      })(r),
      d = c.x,
      u = c.y,
    ...
    if (l) {
      ...
      v === de(i) && (v = ye(i)),
        n === te &&
          ((m = ie), (u -= v.clientHeight - s.height), (u *= o ? 1 : -1)),
        n === ne &&
          ((f = se), (d -= v.clientWidth - s.width), (d *= o ? 1 : -1));
    }
    var _,
      y = Object.assign({ position: a }, l && Me);
    return o
      ? Object.assign(
          Object.assign({}, y),
          {},
      ...
      : We(
          (function (e) {
            var t = ye(e),
              ...
              o = -i.scrollTop;
            return (
              "rtl" === ve(s || t).direction &&
                (a += Math.max(t.clientWidth, s ? s.clientWidth : 0) - n),
              { width: n, height: r, x: a, y: o }
            );
          })(ye(e))
        );
  }
  ...
  function Ve(e, t) {
    ...
    var i = t,
      ...
      w = Ne(v),
      x = Xe({ reference: w, element: _, strategy: "absolute", placement: n }),
  ...
  var Ge = {
    ...
    fn: function (e) {
      ...
      if (!t.modifiersData[s]._skip) {
          ...
          var n = i.mainAxis,
            ...
            _ =
              ...
              (v !== g && f
                ...
                : [De(g)]),
            y = [g].concat(_).reduce(function (e, i) {
              return e.concat(
                "auto" === fe(i)
                  ? (function (e, t) {
                      void 0 === t && (t = {});
        ...
        t.placement !== E &&
          ((t.modifiersData[s]._skip = !0), (t.placement = E), (t.reset = !0));
      }
    },
            ...
            return (
              (e[i] = (function (e, t, i) {
                ...
                return (
                  (a = a || 0),
                  (o = (o || 0) * n),
                  [ne, se].indexOf(s) >= 0 ? { x: o, y: a } : { x: a, y: o }
                );
              })(i, t.rects, r)),
              e
            );
          ...
          setOptions: function (i) {
            ...
            var n,
              ...
              c = (function (e) {
                ...
                ((n = [].concat(s, o.options.modifiers)),
            ...
            return (
              ...
              o.orderedModifiers.forEach(function (e) {
                ...
                if ("function" == typeof n) {
                  var r = n({ state: o, name: t, instance: d, options: s });
                  l.push(r || function () {});
                }
              }),
              d.update()
  ...
  var nt = st(),
    rt = st({ defaultModifiers: [Le, Ze, Oe, pe] }),
    at = st({ defaultModifiers: [Le, Ze, Oe, pe, Ke, Ge, Je, Pe, Qe] }),
    ot = Object.freeze({
      __proto__: null,
      popperGenerator: st,
      detectOverflow: Ve,
    ...
    _t = (function (e) {
      function n(t, i) {
        var s;
        return (
          ((s = e.call(this, t) || this)._popper = null),
          (s._config = s._getConfig(i)),
          (s._menu = s._getMenuElement()),
          (s._inNavbar = s._detectNavbar()),
          s._addEventListeners(),
          s
        );
      }
      ...
      return (
        ...
        (n.dropdownInterface = function (e, t) {
          ...
          if (
            (i || (i = new n(e, "object" == typeof t ? t : null)),
            "string" == typeof t)
          ) {
            if (void 0 === i[t])
              throw new TypeError('No method named "' + t + '"');
          ...
          if (
            ...
            if (i && "Space" !== e.key) {
              ...
              if (s.length) {
                ...
                "ArrowUp" === e.key && r > 0 && r--,
                  "ArrowDown" === e.key && r < s.length - 1 && r++,
                  s[(r = -1 === r ? 0 : r)].focus();
              }
            } else n.clearMenus();
          }
  ...
  N.on(
    ...
    N.on(
      ...
      function (e) {
        e.preventDefault(),
          e.stopPropagation(),
          _t.dropdownInterface(this, "toggle");
      }
    ),
    N.on(
      document,
    ...
    y(function () {
      ...
      if (e) {
        var t = e.fn[lt];
        (e.fn[lt] = _t.jQueryInterface),
          (e.fn[lt].Constructor = _t),
          (e.fn[lt].noConflict = function () {
            return (e.fn[lt] = t), _t.jQueryInterface;
          });
      }
    });
  var yt = { backdrop: !0, keyboard: !0, focus: !0 },
    bt = {
    ...
    wt = (function (e) {
      function n(t, i) {
        var s;
        return (
          ((s = e.call(this, t) || this)._config = s._getConfig(i)),
          (s._dialog = X.findOne(".modal-dialog", t)),
          (s._backdrop = null),
          (s._isShown = !1),
          (s._isBodyOverflowing = !1),
              ...
              function (t) {
                ...
                Y.setDataAttribute(t, "padding-right", i),
                  (t.style.paddingRight =
                    Number.parseFloat(s) + e._scrollbarWidth + "px");
              }
            ),
  ...
  N.on(
    ...
    function (e) {
      ...
      ("A" !== this.tagName && "AREA" !== this.tagName) || e.preventDefault(),
        N.one(s, "show.bs.modal", function (e) {
          e.defaultPrevented ||
            N.one(s, "hidden.bs.modal", function () {
              m(t) && t.focus();
            });
        });
      var n = T(s, "bs.modal");
  ...
  function St(e, t, i) {
    ...
    for (
      var n = new window.DOMParser().parseFromString(e, "text/html"),
        r = Object.keys(t),
        a = (s = []).concat.apply(s, n.body.querySelectorAll("*")),
        o = function (e, i) {
          var s,
            n = a[e],
          ...
          l.forEach(function (e) {
            (function (e, t) {
              ...
              if (t.includes(i))
                return (
                  !xt.has(i) ||
                  Boolean(e.nodeValue.match(Tt) || e.nodeValue.match(Et))
                );
              for (
  ...
  var Ct = "tooltip",
    ...
    It = (function (e) {
      function n(t, i) {
        ...
        return (
          ((s = e.call(this, t) || this)._isEnabled = !0),
          (s._timeout = 0),
          (s._hoverState = ""),
          (s._activeTrigger = {}),
          (s._popper = null),
          (s.config = s._getConfig(i)),
          (s.tip = null),
          s._setListeners(),
          s
        );
      ...
      return (
        ...
        (r.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            x(n, this.constructor.DATA_KEY, this),
              this._element.ownerDocument.documentElement.contains(this.tip) ||
                c.appendChild(n),
              N.trigger(this._element, this.constructor.Event.INSERTED),
              (this._popper = at(this._element, n, this._getPopperConfig(l))),
            ...
            var u,
              ...
              f =
                "function" == typeof this.config.customClass
                  ...
                  : this.config.customClass;
            f && (u = n.classList).add.apply(u, f.split(" ")),
              "ontouchstart" in document.documentElement &&
                (h = []).concat
        ...
        (r._getPopperConfig = function (e) {
          var t = this,
            s = { name: "flip", options: { altBoundary: !0 } };
          return (
            this.config.fallbackPlacements &&
              (s.options.fallbackPlacements = this.config.fallbackPlacements),
            i(
              {},
              {
                placement: e,
        ...
        (n.jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              ...
              (t || (t = new n(this, i)), "string" == typeof e)
            ) {
              if (void 0 === t[e])
                throw new TypeError('No method named "' + e + '"');
              t[e]();
      ...
      return (
        ...
        (i.jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || !/dispose|hide/.test(e)) &&
              (t || ((t = new i(this, s)), x(this, "bs.popover", t)),
              "string" == typeof e)
            ) {
              if (void 0 === t[e])
                throw new TypeError('No method named "' + e + '"');
  ...
  y(function () {
    ...
    if (e) {
      var t = e.fn[Dt];
      (e.fn[Dt] = Ft.jQueryInterface),
        (e.fn[Dt].Constructor = Ft),
  ...
  var Bt = "scrollspy",
    ...
    qt = (function (e) {
      function n(t, i) {
        var s;
        return (
          ((s = e.call(this, t) || this)._scrollElement =
          ...
          (s._offsets = []),
          (s._targets = []),
          (s._activeTarget = null),
          (s._scrollHeight = 0),
          N.on(s._scrollElement, "scroll.bs.scrollspy", function (e) {
            return s._process(e);
          }),
          s.refresh(),
          s._process(),
        ...
        return (
          e.forEach(function (e) {
            if (e instanceof HTMLElement) {
              ...
              t(e, s) && n.push(e);
              for (var i = e.querySelectorAll(s), r = 0; r < i.length; r++)
                n.push(i[r]);
            }
          }),
          n
  ...
  (function (e, t) {
    ...
    return (
      ...
      (i.create = function (e, t) {
        ...
        return (
          ((n.prototype = Object.create(s)).constructor = n),
          t && (n.options = t),
          (i.modes[(n.prototype.namespace = e)] = n)
        );
      }),
      i
    );
  ...
  (function (e, t) {
    ...
    (d._create = function () {
      ...
      (d._filter = function (e) {
        ...
        t = t || "*";
        for (
          var i = [], s = [], n = [], r = this._getFilterTest(t), a = 0;
          a < e.length;
          a++
        ) {
          var o = e[a];
      ...
      (d.updateSortData = function (e) {
        var t;
        (t = e ? ((e = n.makeArray(e)), this.getItems(e)) : this.items),
          this._getSorters(),
  ...
  (function (e) {
    ...
    (e.cleanData =
      ...
      (e.widget.extend = function (t) {
        for (
          var i, n, r = s.call(arguments, 1), a = 0, o = r.length;
          a < o;
          a++
        )
          for (i in r[a])
        ...
        option: function (t, i) {
          ...
          if ("string" == typeof t)
            if (((a = {}), (t = (s = t.split(".")).shift()), s.length)) {
              for (
                n = a[t] = e.widget.extend({}, this.options[t]), r = 0;
                r < s.length - 1;
                r++
              )
                (n[s[r]] = n[s[r]] || {}), (n = n[s[r]]);
        ...
        _classes: function (t) {
          ...
          function n(n, r) {
            for (var a, o = 0; o < n.length; o++)
              (a = s.classesElementLookup[n[o]] || e()),
                (a = t.add
                  ? e(e.unique(a.get().concat(t.element.get())))
                  : e(a.not(t.element).get())),
                (s.classesElementLookup[n[o]] = a),
                i.push(n[o]),
                r && t.classes[n[o]] && i.push(t.classes[n[o]]);
          }
          return (
            (t = e.extend(
          ...
          "boolean" != typeof t && ((s = i), (i = t), (t = !1)),
            ...
            e.each(s, function (s, a) {
              ...
              "string" != typeof a &&
                ...
                (s = (l = s.match(/^([\w:-]*)\s*(.*)$/))[1] + r.eventNamespace),
    ...
    e(document).on("mouseup", function () {
      ...
      e.widget("ui.slider", e.ui.mouse, {
        ...
        _createHandles: function () {
          ...
          for (
            s.length > r && (s.slice(r).remove(), (s = s.slice(0, r))),
              t = s.length;
            t < r;
            t++
          )
        ...
        values: function (t, i) {
          ...
          for (s = this.options.values, n = t, r = 0; r < s.length; r += 1)
      ...
      (t.prototype.handleScroll = function () {
        ...
        for (var i in t) {
          ...
          for (var r in this.waypoints[i]) {
            ...
            ((o && l) || (!o && !l)) &&
              (a.queueTrigger(n), (e[a.group.id] = a.group));
          }
        }
        ...
        (e = {
          ...
          for (var o in this.waypoints[r]) {
            var l,
              ...
              d,
              u,
              h = this.waypoints[r][o],
              p = h.options.offset,
              f = h.triggerPoint,
              m = 0,
              g = null == f;
            h.element !== h.element.window &&
              (m = h.adapter.offset()[a.offsetProp]),
              "function" == typeof p
                ? (p = p.apply(h))
                : "string" == typeof p &&
                  ((p = parseFloat(p)),
              ...
              !g && c && d
                ...
                : ((!g && u) || (g && a.oldScroll >= h.triggerPoint)) &&
      ...
      return function () {
        ...
        return (
          e.isFunction(arguments[0]) &&
            ((s = e.extend({}, arguments[1])).handler = arguments[0]),
          this.each(function () {
            var n = e.extend({}, s, { element: this });
  ...
  (function (e) {
    ...
    (v.prototype = {
      ...
      updateItemHTML: function () {
        ...
        var s = i.type;
        if (
          (x("BeforeChange", [t.currItem ? t.currItem.type : "", s]),
          (t.currItem = i),
          !t.currTemplate[s])
        ) {
              ...
              if (r.length > 0) {
                ...
                "replaceWith" === a
                  ...
                  ? r.is("img")
                    ? r.attr("src", s)
                    : r.replaceWith(
                        e("<img>").attr("src", s).attr("class", r.attr("class"))
                      )
                  : r.attr(n[1], s);
              }
      ...
      (e.fn.magnificPopup = function (i) {
        ...
        if ("string" == typeof i)
          if ("open" === i) {
            var n,
              r = _ ? s.data("magnificPopup") : s[0].magnificPopup,
        ...
        getInline: function (i, s) {
          if ((k(), i.src)) {
            ...
            if (r.length) {
              ...
              a &&
                a.tagName &&
                (C || ((S = n.hiddenClass), (C = w(S)), (S = "mfp-" + S)),
                (P = r.after(C).detach().removeClass(S))),
    ...
    e.magnificPopup.registerModule("image", {
      ...
      proto: {
        ...
        getImage: function (i, s) {
          ...
          return (
            t._parseMarkup(s, { title: z(i), img_replaceWith: i.img }, i),
            t.resizeImage(),
            i.hasSize
              ? (D && clearInterval(D),
                i.loadError
...
var Swiper = (function () {
    ...
    function L(e) {
      ...
      h.matches(a.focusableElements) &&
        ((w = !1), "SELECT" === h.nodeName && (a.isTouched = !1)),
        i.activeElement &&
    ...
    const H = (e, t) => {
        const i = s(),
          { params: n, el: r, wrapperEl: a, device: o } = e,
          l = !!n.nested,
        ...
        update: {
          ...
          updateSlides: function () {
            ...
            "string" == typeof E && E.indexOf("%") >= 0
              ...
              s.centeredSlides &&
                s.cssMode &&
                (u(n, "--swiper-centered-offset-before", ""),
                u(n, "--swiper-centered-offset-after", ""));
            ...
            for (let n = 0; n < p; n += 1) {
              ...
              if (
                ...
                if ("auto" === s.slidesPerView) {
                  ...
                  (k = (a - (s.slidesPerView - 1) * E) / s.slidesPerView),
                    s.roundLengths && (k = Math.floor(k)),
                    h[n] && (h[n].style[t("width")] = k + "px");
                h[n] && (h[n].swiperSlideSize = k),
                  _.push(k),
                  s.centeredSlides
                    ? ((S = S + k / 2 + C / 2 + E),
                      0 === C && 0 !== n && (S = S - a / 2 - E),
            ...
            if (
              ...
              o &&
                ...
                (n.style.width = e.virtualSize + E + "px"),
              s.setWrapperSize &&
                (n.style[t("width")] = e.virtualSize + E + "px"),
              M && e.grid.updateWrapperSize(k, m, t),
              !s.centeredSlides)
            ) {
              const t = [];
            ...
            if (
              ...
              u(n, "--swiper-centered-offset-before", -m[0] + "px"),
                u(
                  n,
          ...
          updateActiveIndex: function (e) {
            ...
            if ((l >= s.length && (l = s.length - 1), c === r))
              return (
        ...
        transition: {
          ...
          transitionStart: function (e, t) {
            ...
            s.cssMode ||
              ...
              A({ swiper: i, runCallbacks: e, direction: t, step: "Start" }));
          },
          transitionEnd: function (e, t) {
            ...
            (i.animating = !1),
              s.cssMode ||
                (i.setTransition(0),
                A({ swiper: i, runCallbacks: e, direction: t, step: "End" }));
          },
        },
        slide: {
          slideTo: function (e, t, i, s, n) {
            ...
            if (
              ...
              (p && -_ === r.translate) || (!p && _ === r.translate))
            )
              return (
                r.updateActiveIndex(a),
                o.autoHeight && r.updateAutoHeight(),
                r.updateSlidesClasses(),
                "slide" !== o.effect && r.setTranslate(_),
                "reset" !== y &&
              ...
              (n = parseInt(
                ...
                t.centeredSlides
                  ? r < e.loopedSlides - s / 2 ||
                    ...
                    ? (e.loopFix(),
                      (r = e.getSlideIndex(
                        f(i, `${o}[data-swiper-slide-index="${n}"]`)[0]
                      )),
                      a(() => {
                        e.slideTo(r);
                      }))
        ...
        loop: {
          loopCreate: function (e) {
            ...
            !i.loop ||
              ...
              (f(s, `.${i.slideClass}, swiper-slide`).forEach((e, t) => {
    ...
    class G {
      ...
      getSlideIndex(e) {
        const { slidesEl: t, params: i } = this,
          s = _(f(t, `.${i.slideClass}, swiper-slide`)[0]);
        return _(e) - s;
      }
      ...
      return (
        e.params.createElements &&
          Object.keys(s).forEach((n) => {
            if (!i[n] && !0 === i.auto) {
              let r = f(e.el, "." + s[n])[0];
              r || ((r = m("div", s[n])), (r.className = s[n]), e.el.append(r)),
                (i[n] = r),
                (t[n] = r);
            }
          }),
    ...
    const re = [
      function (e) {
        ...
        function d(e) {
          const {
            ...
            { from: d, to: u, slides: h, slidesGrid: p, offset: m } = i.virtual;
          i.params.cssMode || i.updateActiveIndex();
          const g = i.activeIndex || 0;
          let v, _, y;
          (v = i.rtlTranslate ? "right" : i.isHorizontal() ? "left" : "top"),
            n
              ? ((_ = Math.floor(t / 2) + s + l),
                (y = Math.floor(t / 2) + s + o))
              : ((_ = t + (s - 1) + l), (y = (r ? t : s) + o));
          let b = g - y,
            w = g + _;
          ...
          if (
            (r && g >= y
              ? ((b -= y), n || (x += i.slidesGrid[0]))
              : r && g < y && ((b = -y), n && (x += i.slidesGrid[0])),
      ...
      function (e) {
        ...
        s("init", () => {
          !t.params.mousewheel.enabled && t.params.cssMode && y(),
            t.params.mousewheel.enabled && _();
        }),
          s("destroy", () => {
            t.params.cssMode && _(), t.mousewheel.enabled && y();
          }),
          Object.assign(t.mousewheel, { enable: _, disable: y });
      },
      function (e) {
        let { swiper: t, extendParams: i, on: s, emit: n } = e;
        i({
          ...
          "string" == typeof e.el &&
            ...
            i &&
              ...
              (t.params.uniqueNavElements &&
                ...
                i.length > 1 &&
                  (i = i.filter((e) => y(e, ".swiper")[0] === t.el)[0])),
      ...
      function (e) {
        ...
        function E(e) {
          ...
          if (!n) return;
          const r = n,
            a = !!s.passiveListeners && { passive: !1, capture: !1 },
        ...
        function S() {
          ...
          "string" == typeof s.el &&
            ...
            n &&
              ((r = n.querySelector("." + t.params.scrollbar.dragClass)),
              r || ((r = m("div", t.params.scrollbar.dragClass)), n.append(r))),
      ...
      function (e) {
        ...
        function x(e) {
          if (("mouse" === e.pointerType && h.splice(0, h.length), !w(e)))
            return;
          ...
          if (((o = !1), (c = !1), h.push(e), !(h.length < 2))) {
            if (((o = !0), (p.scaleStart = b()), !p.slideEl)) {
              ...
              if (
                ...
                (p.imageEl = s),
                (p.imageWrapEl = s
                  ? y(p.imageEl, "." + i.containerClass)[0]
                  : void 0),
                !p.imageWrapEl)
              )
        ...
        function T(e) {
          ...
          n >= 0 && (h[n] = e),
            h.length < 2 ||
              ...
              (p.scaleMove = b()),
              p.imageEl &&
                ((s.scale = (p.scaleMove / p.scaleStart) * d),
                s.scale > p.maxRatio &&
                  (s.scale =
        ...
        function S(e) {
          ...
          if (
            ((m.minX = Math.min(p.slideWidth / 2 - s / 2, 0)),
            (m.maxX = -m.minX),
            (m.minY = Math.min(p.slideHeight / 2 - n / 2, 0)),
            (m.maxY = -m.minY),
        ...
        function P(e) {
          ...
          if (!p.slideEl) {
            ...
            i &&
              ...
              (p.imageEl = i),
              (p.imageWrapEl = i
                ? y(p.imageEl, "." + s.containerClass)[0]
                : void 0);
          }
          ...
          1 === d && k && ((n = void 0), (r = void 0)),
            ...
            !e || (1 === d && k)
              ? ((h = 0), (v = 0))
              : ((P = p.slideEl.offsetWidth),
                (M = p.slideEl.offsetHeight),
                (o = g(p.slideEl).left + a.scrollX),
                (l = g(p.slideEl).top + a.scrollY),
                (c = o + P / 2 - n),
                (u = l + M / 2 - r),
                (_ = p.imageEl.offsetWidth),
                (b = p.imageEl.offsetHeight),
                (w = _ * i.scale),
                (x = b * i.scale),
                (T = Math.min(P / 2 - w / 2, 0)),
                (E = Math.min(M / 2 - x / 2, 0)),
                (S = -T),
                (C = -E),
                (h = c * i.scale),
                (v = u * i.scale),
                ...
                v < E && (v = E),
                v > C && (v = C)),
            k && 1 === i.scale && ((p.originX = 0), (p.originY = 0)),
        ...
        function A() {
          ...
          t.wrapperEl.addEventListener("pointerdown", x, i),
            t.wrapperEl.addEventListener("pointermove", T, s),
        ...
        function L() {
          ...
          t.wrapperEl.removeEventListener("pointerdown", x, i),
            t.wrapperEl.removeEventListener("pointermove", T, s),
            ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            ...
            t.zoom.enabled &&
              (function () {
                ...
                0 !== v.x && (i = Math.abs((r - m.currentX) / v.x)),
                  0 !== v.y && (s = Math.abs((o - m.currentY) / v.y));
                const l = Math.max(i, s);
                (m.currentX = r), (m.currentY = o);
                const c = m.width * e.scale,
                  d = m.height * e.scale;
                (m.minX = Math.min(p.slideWidth / 2 - c / 2, 0)),
                  (m.maxX = -m.minX),
                  (m.minY = Math.min(p.slideHeight / 2 - d / 2, 0)),
                  (m.maxY = -m.minY),
      ...
      function (e) {
        ...
        function f(e) {
          ...
          (t.pagination &&
            ...
            t.pagination &&
              s.matches(U(t.params.pagination.bulletClass)) &&
              s.click());
        }
        function g() {
          return (
        ...
        s("beforeInit", () => {
          (n = m("span", t.params.a11y.notificationClass)),
          ...
          s("afterInit", () => {
            t.params.a11y.enabled &&
              (() => {
                ...
                (h = a(h)),
                  (p = a(p)),
                  h && h.forEach((t) => y(t, r, e.nextSlideMessage)),
                  p && p.forEach((t) => y(t, r, e.prevSlideMessage)),
                  v() &&
          ...
          s("fromEdge toEdge afterInit lock unlock", () => {
            t.params.a11y.enabled &&
              (function () {
                ...
                const { nextEl: e, prevEl: i } = t.navigation;
                i && (t.isBeginning ? (h(i), l(i)) : (p(i), o(i))),
                  e && (t.isEnd ? (h(e), l(e)) : (p(e), o(e)));
              })();
          }),
          s("paginationUpdate", () => {
            t.params.a11y.enabled &&
      ...
      function (e) {
        let t,
          i,
          { swiper: n, extendParams: r, on: a, emit: o, params: l } = e;
        ...
        function y(e) {
          n &&
            ...
            (n.wrapperEl.removeEventListener("transitionend", y), S());
        }
        const b = () => {
          ...
          P = (e) => {
            "mouse" === e.pointerType &&
              ((m = !0), n.animating || n.autoplay.paused || E(!0));
          },
          M = (e) => {
        ...
        a("init", () => {
          ...
          a("beforeTransitionStart", (e, t, i) => {
            !n.destroyed &&
              n.autoplay.running &&
              (i || !n.params.autoplay.disableOnInteraction ? E(!0, !0) : T());
          }),
          a("sliderFirstMove", () => {
            !n.destroyed &&
              n.autoplay.running &&
          ...
          Object.assign(n.autoplay, { start: x, stop: T, pause: E, resume: S });
      },
      function (e) {
                    ...
                    if (d.velocities.length > 1) {
                      ...
                      (t.velocity = s / n),
                        ...
                        Math.abs(t.velocity) < r.freeMode.minimumVelocity &&
                          (t.velocity = 0),
                        (n > 150 || o() - e.time > 300) && (t.velocity = 0);
                    } else t.velocity = 0;
        ...
        o("init", () => {
          ...
          (r.grid = {
            ...
            updateSlide: (e, n, a, o) => {
              ...
              (n.row = m),
                (n.column = f),
                (n.style[o("margin-top")] = 0 !== m ? d && d + "px" : "");
            },
            updateWrapperSize: (e, i, s) => {
              const { centeredSlides: n, roundLengths: a } = r.params,
                o = l(),
        ...
        const n = (e, i) => {
          let s = t.isHorizontal()
            ...
            n = t.isHorizontal()
              ? e.querySelector(".swiper-slide-shadow-right")
              : e.querySelector(".swiper-slide-shadow-bottom");
          s || (s = ne("flip", e, t.isHorizontal() ? "left" : "top")),
            n || (n = ne("flip", e, t.isHorizontal() ? "right" : "bottom")),
        ...
        te({
          ...
          setTransition: (e) => {
            ...
            i.forEach((t) => {
              ...
              se({ swiper: t, duration: e, transformElements: i });
          },
          recreateShadows: () => {
            t.params.flipEffect,
              t.slides.forEach((e) => {
            ...
            setTranslate: () => {
              ...
              for (let e = 0, t = s.length; e < t; e += 1) {
                ...
                if (
                  ...
                  e || (e = ne("coverflow", t, a ? "left" : "top")),
                    i || (i = ne("coverflow", t, a ? "right" : "bottom")),
          ...
          setTranslate: () => {
            ...
            for (let i = 0; i < e.length; i += 1) {
              ...
              c < 0
                ...
                : c > 0 && ((m = r.prev), (f = !0)),
                h.forEach((e, t) => {
                  h[t] = `calc(${e}px + (${n(m.translate[t])} * ${Math.abs(
                    c * a
                  )}))`;
                }),
                p.forEach((e, t) => {
            ...
            setTranslate: () => {
              ...
              for (let l = 0; l < e.length; l += 1) {
                ...
                let g = 1,
                  ...
                  _ = n.perSlideOffset - 0.75 * Math.abs(u);
                const y =
                    t.virtual && t.params.virtual.enabled
                      ? t.virtual.from + l
                      : l,
 ...
 **/ (_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  _gsScope._gsDefine(
    ...
    function (e, t, i) {
      var s = function (e) {
        ...
        n = function (e, t, i) {
          ...
          for (s in r)
            (n = r[s]),
              (e[s] =
                "function" == typeof n ? n.call(t[i], i) : n[i % n.length]);
          delete e.cycle;
        },
        r = function (e, t, s) {
          i.call(this, e, t, s),
        ...
        (d.updateTo = function (e, t) {
          ...
          if (this._initted || r)
            if (t) (this._initted = !1), r && this.render(0, !0, !0);
              ...
              for (var o, l = 1 / (1 - n), c = this._firstPT; c; )
            ...
            (e >= p
              ? ((this._totalTime = p),
                ...
                0 === v &&
                  ...
                  (0 === e || 0 > _ || _ === a) &&
                    _ !== e &&
                    ((i = !0), _ > a && (n = "onReverseComplete")),
                  (this._rawPrevTime = h = !t || e || _ === e ? e : a)))
              : 1e-7 > e
        ...
        (r.staggerTo = r.allTo =
          function (e, t, a, o, d, h, p) {
            ...
            var f,
              ...
              b = function () {
                a.onComplete &&
                  ...
                  d.apply(p || a.callbackScope || this, h || u);
              },
              w = a.cycle,
            ...
            for (
              ...
              if ((w && n(m, e, g), x)) {
                for (v in ((x = m.startAt = {}), a.startAt))
                  x[v] = a.startAt[v];
                n(m.startAt, e, g);
              }
              (m.delay = _),
                g === f && d && (m.onComplete = b),
                (y[g] = new r(e[g], t, m)),
                (_ += o);
            }
            return y;
        ...
        (r.staggerFrom = r.allFrom =
          function (e, t, i, s, n, a, o) {
            return (
              (i.runBackwards = !0),
              (i.immediateRender = 0 != i.immediateRender),
              r.staggerTo(e, t, i, s, n, a, o)
            );
          }),
        (r.staggerFromTo = r.allFromTo =
          function (e, t, i, s, n, a, o, l) {
            return (
              (s.startAt = i),
              (s.immediateRender =
                0 != s.immediateRender && 0 != i.immediateRender),
              r.staggerTo(e, t, s, n, a, o, l)
            );
          }),
      ...
      var h = function (e, t) {
          for (var s = [], n = 0, r = e._first; r; )
            r instanceof i
              ? (s[n++] = r)
              : (t && (s[n++] = r), (n = (s = s.concat(h(r, t))).length)),
              (r = r._next);
          return s;
        },
        ...
        (r.killChildTweensOf = function (e, t) {
          if (null != e) {
            ...
            if (
              ...
              for (d in ((n = []), p))
                for (a = p[d].target.parentNode; a; )
                  a === e && (n = n.concat(p[d].tweens)), (a = a.parentNode);
              for (h = n.length, u = 0; h > u; u++)
                t && n[u].totalTime(n[u].totalDuration()),
                  n[u]._enabled(!1, !1);
            }
          }
        });
      var f = function (e, i, s, n) {
        (i = !1 !== i), (s = !1 !== s);
        for (
          var r, a, o = p((n = !1 !== n)), l = i && s && n, c = o.length;
          --c > -1;
      ...
      return (
        ...
        (r.globalTimeScale = function (t) {
          ...
          return arguments.length
            ? ((t = t || a),
              (s._startTime = n - ((n - s._startTime) * s._timeScale) / t),
              (s = e._rootFramesTimeline),
              (n = i.ticker.frame),
              (s._startTime = n - ((n - s._startTime) * s._timeScale) / t),
              (s._timeScale = e._rootTimeline._timeScale = t),
              t)
            : s._timeScale;
        }),
        ...
        return (
          ...
          (g.staggerTo = function (e, t, n, r, a, l, c, d) {
            ...
            for (
              "string" == typeof e && (e = i.selector(e) || e),
                o((e = e || [])) && (e = m(e)),
                0 > (r = r || 0) && ((e = m(e)).reverse(), (r *= -1)),
                f = 0;
              e.length > f;
              f++
            )
              (u = h(n)).startAt &&
                ((u.startAt = h(u.startAt)),
                u.startAt.cycle && p(u.startAt, e, f)),
                v && p(u, e, f),
                g.to(e[f], t, u, f * r);
            return this.add(g, a);
          }),
          (g.staggerFrom = function (e, t, i, s, n, r, a, o) {
            return (
              (i.immediateRender = 0 != i.immediateRender),
              (i.runBackwards = !0),
              this.staggerTo(e, t, i, s, n, r, a, o)
            );
          }),
          (g.staggerFromTo = function (e, t, i, s, n, r, a, o, l) {
            return (
              ...
              (s.immediateRender =
                0 != s.immediateRender && 0 != i.immediateRender),
              this.staggerTo(e, t, s, n, r, a, o, l)
            );
          }),
          ...
          (g.set = function (e, t, s) {
            return (
              ...
              null == t.immediateRender &&
                (t.immediateRender = s === this._time && !this._paused),
              this.add(new i(e, 0, t), s)
            );
          }),
          ...
          (g.add = function (n, r, a, o) {
            ...
            if (
              ...
              if (n instanceof Array || (n && n.push && l(n))) {
                for (
                  a = a || "normal", o = o || 0, c = r, d = n.length, u = 0;
                  d > u;
                  u++
                )
                  l((h = n[u])) && (h = new s({ tweens: h })),
                    this.add(h, c),
                    "string" != typeof h &&
                      "function" != typeof h &&
                      ("sequence" === a
                        ? (c = h._startTime + h.totalDuration() / h._timeScale)
                        : "start" === a && (h._startTime -= h.delay())),
                    (c += o);
          ...
          (g._parseTimeOrLabel = function (t, i, s, n) {
            ...
            if ("string" == typeof i)
              return this._parseTimeOrLabel(
                i,
                s && "number" == typeof t && null == this._labels[i]
                  ? t - this.duration()
                  : 0,
                s
              );
            if (
              ...
              (i =
                ...
                (t =
                  r > 1
                    ? this._parseTimeOrLabel(t.substr(0, r - 1), 0, s)
                    : this.duration());
            }
            return Number(t) + i;
          }),
          ...
          (g.render = function (e, t, i) {
            ...
            if (e >= h)
              ...
              if (this._hasPause && !this._forcingPlayhead && !t) {
                if (e >= p)
                  for (s = this._first; s && e >= s._startTime && !u; )
                    s._duration ||
                      "isPause" !== s.data ||
                      s.ratio ||
                  ...
                  for (s = this._last; s && s._startTime >= e && !u; )
                    s._duration ||
            ...
            if ((this._time !== p && this._first) || i || l || u) {
              if (
                ...
                for (
                  s = this._last;
                  s && ((a = s._prev), !this._paused || g);

                ) {
                  if (
                    s._active ||
                    (p >= s._startTime && !s._paused && !s._gc)
                  ) {
                    if (u === s) {
              ...
              this._onUpdate &&
                (t || (c.length && d(), this._callback("onUpdate"))),
                o &&
                  (this._gc ||
          ...
          (g._hasPausedChild = function () {
            for (var e = this._first; e; ) {
              if (e._paused || (e instanceof s && e._hasPausedChild()))
                return !0;
              e = e._next;
            }
            return !1;
            ...
            for (var r = [], a = this._first, o = 0; a; )
              n > a._startTime ||
                (a instanceof i
                  ...
                  : (!1 !== s && (r[o++] = a),
                    !1 !== e &&
                      (o = (r = r.concat(a.getChildren(!0, t, s))).length))),
                (a = a._next);
            return r;
          }),
          (g.getTweensOf = function (e, t) {
            var s,
              ...
              o = 0;
            for (
              r && this._enabled(!0, !0), n = (s = i.getTweensOf(e)).length;
              --n > -1;

            )
              (s[n].timeline === this || (t && this._contains(s[n]))) &&
                (a[o++] = s[n]);
          ...
          (g.totalDuration = function (e) {
            if (!arguments.length) {
              if (this._dirty) {
                for (var t, i, s = 0, n = this._last, r = 999999999999; n; )
                  (t = n._prev),
                    ...
                    0 > n._startTime &&
                      ...
                      (r = 0)),
                    (i = n._startTime + n._totalDuration / n._timeScale) > s &&
                      (s = i),
                    (n = t);
      ...
      function (e, t, i) {
        ...
        return (
          ...
          (c.tweenFromTo = function (e, t, i) {
            ...
            return s.duration(
              Math.abs(s.vars.time - e) / this._timeScale || 0.001
            );
          }),
          (c.render = function (e, t, i) {
            ...
            if (e >= p)
              ...
              if (
                ...
                (0 !== m ||
                  (0 === f &&
                    ...
                    (y > 0 || (0 > e && y >= 0)) &&
                    !this._locked)) &&
                  ((c = "onReverseComplete"), (r = this._reversed)),
                0 > e)
              )
                (this._active = !1),
                  this._timeline.autoRemoveChildren && this._reversed
                    ? ((d = r = !0), (c = "onReverseComplete"))
                    : y >= 0 && this._first && (d = !0),
                  (this._rawPrevTime = e);
              else {
                if (
              ...
              if ((e = this._time) >= m)
                for (s = this._first; s && e >= s._startTime && !h; )
                  s._duration ||
                    "isPause" !== s.data ||
                    s.ratio ||
                    (0 === s._startTime && 0 === this._rawPrevTime) ||
                ...
                for (s = this._last; s && s._startTime >= e && !h; )
                  s._duration ||
                    ("isPause" === s.data && s._rawPrevTime > 0 && (h = s)),
                    (s = s._prev);
              h &&
                ((this._time = e = h._startTime),
                (this._totalTime =
          ...
          (c.getLabelAfter = function (e) {
            ...
            var t,
              ...
              s = i.length;
            for (t = 0; s > t; t++) if (i[t].time > e) return i[t].name;
            return null;
          }),
    ...
    (l = function (e, n, r, a, l) {
      ...
      for (c = 0; x > c; c++)
        (d = (p = e[T]).a),
          ...
          l
            ? ((y = t[c]),
              (w = (0.25 * ((b = i[c]) + y) * n) / (a ? 0.5 : s[c] || 0.5)),
              (g =
                u -
                ((f = u - (u - d) * (a ? 0.5 * n : 0 !== y ? w / y : 0)) +
                  ((((m = u + (h - u) * (a ? 0.5 * n : 0 !== b ? w / b : 0)) -
                    f) *
                    ((3 * y) / (y + b) + 0.5)) /
                    4 || 0))))
            : (g =
                u -
                ((f = u - 0.5 * (u - d) * n) + (m = u + 0.5 * (h - u) * n)) /
                  2),
          (f += g),
          (m += g),
          (p.c = v = f),
      ...
      ((p = e[T]).b = E),
        ...
        (p.ba = E - p.a),
        r &&
          ((_ = o(p.a, E, p.c, p.d)), e.splice(T, 1, _[0], _[1], _[2], _[3]));
    }),
    (c = function (e, s, n, r) {
      var o,
        l,
      ...
      if (r)
        for (l = (e = [r].concat(e)).length; --l > -1; )
          "string" == typeof (h = e[l][s]) &&
            "=" === h.charAt(1) &&
            (e[l][s] = r[s] + Number(h.charAt(0) + h.substr(2)));
      if (0 > (o = e.length - 2))
        return (p[0] = new a(e[0][s], 0, 0, e[-1 > o ? 0 : 1][s])), p;
      for (l = 0; o > l; l++)
        (c = e[l][s]),
          (d = e[l + 1][s]),
          (p[l] = new a(c, 0, 0, d)),
    ...
    (d = function (e, r, a, o, d, u) {
      ...
      if (e.length > 1) {
        for (y = e[e.length - 1], _ = !0, h = w.length; --h > -1; )
          if (((p = w[h]), Math.abs(x[p] - y[p]) > 0.05)) {
            _ = !1;
            break;
          }
        _ &&
      ...
      for (t.length = i.length = s.length = 0, h = w.length; --h > -1; )
        (p = w[h]),
          (n[p] = -1 !== d.indexOf("," + p + ",")),
          (b[p] = c(e, p, n[p], u));
      for (h = t.length; --h > -1; )
      ...
      if (!o) {
        for (h = w.length; --h > -1; )
          if (n[p])
            for (v = (f = b[w[h]]).length - 1, m = 0; v > m; m++)
              (g = f[m + 1].da / i[m] + f[m].da / t[m]),
                (s[m] = (s[m] || 0) + g * g);
        for (h = s.length; --h > -1; ) s[h] = Math.sqrt(s[h]);
      }
      for (h = w.length, m = a ? 4 : 1; --h > -1; )
        (f = b[(p = w[h])]),
          l(f, r, a, o, n[p]),
    ...
    (u = function (e, t, i) {
      ...
      for (c = _.length; --c > -1; ) {
        for (m[(h = _[c])] = l = [], p = 0, u = e.length, d = 0; u > d; d++)
          (s =
            null == i
              ? e[d][h]
              : "string" == typeof (f = e[d][h]) && "=" === f.charAt(1)
              ? i[h] + Number(f.charAt(0) + f.substr(2))
              : Number(f)),
            v && d > 1 && u - 1 > d && (l[p++] = (s + l[p - 2]) / 2),
            (l[p++] = s);
        for (u = p - g + 1, p = 0, d = 0; u > d; d += g)
          (s = l[d]),
            (n = l[d + 1]),
            (r = l[d + 2]),
            (o = 2 === g ? 0 : l[d + 3]),
    ...
    (h = function (e, t, i) {
      for (
        var s, n, r, a, o, l, c, d, u, h, p, f = 1 / i, m = e.length;
        --m > -1;
        ...
        for (
          ...
          (s =
            n -
            (n =
              ((c = f * d) * c * a + 3 * (u = 1 - c) * (c * o + u * l)) * c)),
            (t[(p = m * i + d - 1)] = (t[p] || 0) + s * s);
    }),
    (p = function (e, t) {
      var i,
        s,
      ...
      init: function (e, t, i) {
        ...
        for (r = this._props.length; --r > -1; )
          (s = this._props[r]),
            ...
            (n = this._func[s] = "function" == typeof e[s]),
            (c[s] = n
              ? e[
                  s.indexOf("set") ||
          ...
          for (n = T.length; --n > -1; )
            (r = T[n][2]),
              ...
              a &&
                ...
                (y += (a.c + (a.d - a.c) * o - y) * o),
                (_ = g.a + (g.b - g.a) * o),
                (_ += ((b = g.b + (g.c - g.b) * o) - _) * o),
                (b += (g.c + (g.d - g.c) * o - b) * o),
                (l = m
                  ? Math.atan2(b - _, y - v) * x + w
      ...
      if (e) {
        ...
        t._registerComplexSpecialProp("bezier", {
          parser: function (e, t, r, a, o, l) {
            ...
            if (0 > p) return o;
            for (c = 0; p >= c; c++)
              (u = i(e, h[c], a, o, l, p !== c)), (m[c] = u.end);
            for (d in t) g[d] = t[d];
            return (
              (g.values = m),
              ((o = new n(e, "bezier", 0, 0, u.pt, 2)).data = u),
              (o.plugin = l),
              (o.setRatio = s),
    ...
    (m._roundProps = function (e, t) {
      for (var i = this._overwriteProps, s = i.length; --s > -1; )
        (e[i[s]] || e.bezier || e.bezierThrough) && (this._round[i[s]] = t);
    }),
    (m._kill = function (e) {
      var t,
        i,
      ...
      for (t in this._beziers)
        if (t in e)
          for (
            delete this._beziers[t], delete this._func[t], i = s.length;
            --i > -1;
    ...
    _gsScope._gsDefine(
      ...
      function (e, t) {
        ...
        var d,
          ...
          N = function (e) {
            return R.createElementNS
              ? R.createElementNS("http://www.w3.org/1999/xhtml", e)
              : R.createElement(e);
          },
          j = N("div"),
          F = N("img"),
            ...
            return W || "opacity" !== t
              ? (!s && e.style[t]
                  ...
                  ? (r =
                      ...
                      i.getPropertyValue(t.replace(S, "-$1").toLowerCase()))
          ...
          Q = (B.convertToPixels = function (e, i, s, n, r) {
            ...
            var o,
              ...
              h = j.style,
              p = 0 > s;
            if ((p && (s = -s), "%" === n && -1 !== i.indexOf("border")))
              o = (s / 100) * (d ? e.clientWidth : e.clientHeight);
            else {
              if (
                ((h.cssText =
                ...
                h[d ? "borderLeftWidth" : "borderTopWidth"] = s + n;
              else {
                if (
                  ((l = (u = e.parentNode || R.body)._gsCache),
                  (c = t.ticker.frame),
                  l && d && l.time === c)
                )
              ...
              u.appendChild(j),
                (o = parseFloat(j[d ? "offsetWidth" : "offsetHeight"])),
                u.removeChild(j),
                d &&
                  "%" === n &&
                  !1 !== a.cacheWidths &&
          ...
          K = (B.calculateOffset = function (e, t, i) {
            ...
            var s = "left" === t ? "Left" : "Top",
              n = U(e, "margin" + s, i);
            return (
              e["offset" + s] - (Q(e, t, parseFloat(n), n.replace(b, "")) || 0)
            );
          }),
          Z = function (e, t) {
            var i,
            ...
            if ((t = t || $(e, null)))
              if ((i = t.length))
                for (; --i > -1; )
                  (-1 === (n = t[i]).indexOf("-transform") || Se === n) &&
                    (r[n.replace(C, M)] = t.getPropertyValue(n));
              else
                for (i in t)
                  (-1 === i.indexOf("Transform") || Ee === i) && (r[i] = t[i]);
          ...
          ie = function (e, t, i) {
            var s = parseFloat("width" === t ? e.offsetWidth : e.offsetHeight),
              ...
              r = n.length;
            for (i = i || $(e, null); --r > -1; )
              (s -= parseFloat(U(e, "padding" + n[r], i, !0)) || 0),
                (s -= parseFloat(U(e, "border" + n[r] + "Width", i, !0)) || 0);
            return s;
          },
          se = function (e, t) {
            ...
            return (
              ...
              ("center" === s ||
                ...
                (s = "50%"),
              (e = s + " " + n + (i.length > 2 ? " " + i[2] : "")),
              t &&
                ((t.oxp = -1 !== s.indexOf("%")),
                (t.oyp = -1 !== n.indexOf("%")),
                (t.oxr = "=" === s.charAt(1)),
                (t.oyr = "=" === n.charAt(1)),
                (t.ox = parseFloat(s.replace(y, ""))),
                (t.oy = parseFloat(n.replace(y, ""))),
                (t.v = e)),
              t || e
            );
          },
          ...
          ce = (a.parseColor = function (e, t) {
            ...
            return (
              t &&
                ...
                (n = i[1] / 255),
                (r = i[2] / 255),
                (l = ((c = Math.max(s, n, r)) + (d = Math.min(s, n, r))) / 2),
                c === d
                  ? (a = o = 0)
                  : ((u = c - d),
          ...
          de = function (e, t) {
            ...
            for (i = 0; r.length > i; i++)
              (s = r[i]),
                (a += (n = e.substr(a, e.indexOf(s, a) - a)).length + s.length),
                3 === (s = ce(s, t)).length && s.push(1),
                (o +=
                  n +
                  (t
        ...
        var he = function (e, t, i, s) {
            ...
            return d
              ? (n = t
                  ? function (e) {
                      ...
                      if (
                        ((t = (e.match(ue) || [r])[0]),
                        (p = (h = e.split(t).join("").match(_) || []).length),
                        d > p--)
                      )
                        for (; d > ++p; )
                          h[p] = i ? h[0 | ((p - 1) / 2)] : a[p];
            ...
            ((B._setPluginRatio = function (e) {
              ...
              for (
                ...
                (t = a[o.v]),
                  ...
                  (o = o._next);
              if (
                (r.autoRotate && (r.autoRotate.rotation = a.rotation), 1 === e)
              )
                for (o = r.firstMPT; o; ) {
                  if ((i = o.t).type) {
                    if (1 === i.type) {
          ...
          me =
            ((B._parseToProxy = function (e, t, i, s, n, r) {
              var a,
                o,
                l,
                c,
                ...
                if (
                  ...
                  for (a = s.l; --a > 0; )
                    (l = "xn" + a),
                      ...
                      (h[o] = s[l]),
                      r || (c = new fe(s, l, o, c, s.rxp[l]));
                s = s._next;
              }
              return { proxy: h, end: p, firstMPT: c, pt: d };
            }),
            (B.CSSPropTween = function (e, t, s, n, a, o, l, c, d, u, h) {
              (this.t = e),
                ...
                (this.c = n),
                (this.n = l || t),
                e instanceof me || r.push(this.n),
                (this.r = c),
                (this.type = o || 0),
                d && ((this.pr = d), (i = !0)),
                (this.b = void 0 === u ? s : u),
                (this.e = void 0 === h ? s + n : h),
          ...
          ve = (a.parseComplex = function (e, t, i, s, n, r, a, o, l, c) {
            ...
            for (
              ...
              if (((f = C[u]), (m = P[u]), (b = parseFloat(f)) || 0 === b))
                a.appendXtra(
                  "",
                  b,
                  ne(m, b),
            ...
            if (-1 !== s.indexOf("=") && a.data) {
              for (E = a.xs0 + a.data.s, u = 1; a.l > u; u++)
                E += a["xs" + u] + a.data["xn" + u];
              a.e = E + a["xs" + u];
            }
            return a.l || ((a.type = -1), (a.xs0 = a.e)), a.xfirst || a;
          }),
          _e = 9;
        for ((c = me.prototype).l = c.pr = 0; --_e > 0; )
          (c["xn" + _e] = 0), (c["xs" + _e] = "");
        (c.xs0 = ""),
          (c._next =
            c._prev =
            ...
            c.rxp =
              null),
          (c.appendXtra = function (e, t, i, s, n, r) {
            var a = this,
              o = a.l;
            return (
              (a["xs" + o] += r && o ? " " + e : e || ""),
        ...
        var ye = function (e, t) {
            (t = t || {}),
              ...
              (this.format =
                t.formatter ||
                he(t.defaultValue, t.color, t.collapsible, t.multi)),
          ...
          be = (B._registerComplexSpecialProp = function (e, t, i) {
            ...
            var s,
              n = e.split(","),
              r = t.defaultValue;
            for (i = i || [r], s = 0; n.length > s; s++)
              (t.prefix = 0 === s && t.prefix),
                (t.defaultValue = i[s] || r),
                new ye(n[s], t);
          }),
          we = function (e) {
            if (!l[e]) {
              ...
              be(e, {
                parser: function (e, i, s, n, r, a, c) {
                  ...
                  return d
                    ? (d._cssRegister(), l[s].parse(e, i, s, n, r, a, c))
                    : (Y("Error: " + t + " js file not loaded."), r);
                },
              });
            }
          };
        ((c = ye.prototype).parseComplex = function (e, t, i, s, n, r) {
          ...
          if (
            ...
            for (
              ...
              (t = o[a] = o[a] || this.dflt),
                (i = l[a] = l[a] || this.dflt),
                h &&
                  (d = t.indexOf(h)) !== (u = i.indexOf(h)) &&
                  (-1 === u
                    ? (o[a] = o[a].split(h).join(""))
                    : -1 === d && (o[a] += " " + h));
            (t = o.join(", ")), (i = l.join(", "));
          }
          ...
          (c.parse = function (e, t, i, s, r, a) {
            return this.parseComplex(
              e.style,
              this.format(U(e, this.p, n, !1, this.dflt)),
              this.format(t),
              r,
              a
            );
        ...
        var xe,
          ...
          Me = (B.Transform = function () {
            (this.perspective = parseFloat(a.defaultTransformPerspective) || 0),
              (this.force3D =
                !(!1 === a.defaultForce3D || !Pe) &&
                (a.defaultForce3D || "auto"));
          }),
          ke = window.SVGElement,
          Oe = function (e, t, i) {
            var s,
              n = R.createElementNS("http://www.w3.org/2000/svg", e),
              r = /([a-z])([A-Z])/g;
            for (s in i)
          ...
          Le = (function () {
            ...
            return (
              R.createElementNS &&
                ...
                (s = i === t.getBoundingClientRect().width && !(p && Pe)),
                Ae.removeChild(e)),
              s
            );
          })(),
              ...
              b &&
                (n || (!1 !== n && !1 !== a.defaultSmoothOrigin)
                  ? ((o = c - _),
                    ...
                    (b.yOffset += o * w[1] + l * w[3] - l))
                  : (b.xOffset = b.yOffset = 0)),
              e.setAttribute("data-svg-origin", r.join(" "));
          },
          De = function (e) {
            return !!(
              ke &&
          ...
          Re = function (e, t) {
            ...
            if (
              (Ee
                ...
                : e.currentStyle &&
                  (s =
                    (s = e.currentStyle.filter.match(O)) && 4 === s.length
                      ? [
                          s[0].substr(4),
                          Number(s[2].substr(4)),
                          Number(s[1].substr(4)),
              ...
              (o.svg || (e.getBBox && De(e))) &&
                (i &&
                  -1 !== (e.style[Ee] + "").indexOf("matrix") &&
                  ((s = e.style[Ee]), (i = 0)),
          ...
          Ne = (B.getTransform = function (e, i, s, r) {
            ...
            var o,
              ...
              u,
              h,
              p = (s && e._gsTransform) || new Me(),
              f = 0 > p.scaleX,
              m = 2e-5,
              g = 1e5,
              v =
                (Pe &&
                  (parseFloat(U(e, Ce, i, !1, "0 0 0").split(" ")[2]) ||
                    p.zOrigin)) ||
                0,
              _ = parseFloat(a.defaultTransformPerspective) || 0;
            if (
              ((p.svg = !(!e.getBBox || !De(e))),
              p.svg &&
                (Ie(
                  e,
                  U(e, Ce, n, !1, "50% 50%") + "",
              ...
              if (16 === o.length) {
                var y,
                  ...
                  B = Math.atan2(O, z);
                p.zOrigin &&
                  ((R = L * (j = -p.zOrigin) - o[12]),
                  (N = I * j - o[13]),
                  (j = z * j + p.zOrigin - o[14])),
                  (p.rotationX = B * D),
                  B &&
                    ((y = M * (x = Math.cos(-B)) + L * (T = Math.sin(-B))),
                    (b = k * x + I * T),
                    (w = O * x + z * T),
                    (L = M * -T + L * x),
                    (I = k * -T + I * x),
                  ...
                  (p.rotationY = B * D),
                  B &&
                    ((b = S * (x = Math.cos(-B)) - I * (T = Math.sin(-B))),
                    (w = C * x - z * T),
                    (I = S * T + I * x),
                    (z = C * T + z * x),
                    (F = P * T + F * x),
                  ...
                  (p.rotation = B * D),
                  B &&
                    ((E = E * (x = Math.cos(-B)) + M * (T = Math.sin(-B))),
                    (b = S * x + k * T),
                    (k = S * -T + k * x),
                    (O = C * -T + O * x),
                    (S = b)),
                  ...
                  (p.scaleX = (0 | (Math.sqrt(E * E + S * S) * g + 0.5)) / g),
                  (p.scaleY = (0 | (Math.sqrt(k * k + I * I) * g + 0.5)) / g),
                  (p.scaleZ = (0 | (Math.sqrt(O * O + z * z) * g + 0.5)) / g),
                  (p.skewX = 0),
                  ...
                  (p.z = j),
                  p.svg &&
                    ((p.x -= p.xOrigin - (p.xOrigin * E - p.yOrigin * M)),
                    (p.y -= p.yOrigin - (p.yOrigin * S - p.xOrigin * k)));
              } else if (
                !(
                  (Pe &&
                    !r &&
                ...
                (p.x = o[4] || 0),
                  ...
                  (c = Math.sqrt(W * W + q * q)),
                  (d = Math.sqrt(X * X + Y * Y)),
                  (u = W || q ? Math.atan2(q, W) * D : p.rotation || 0),
                  (h = Y || X ? Math.atan2(Y, X) * D + u : p.skewX || 0),
                  Math.abs(h) > 90 &&
                    270 > Math.abs(h) &&
                    (f
                      ? ((c *= -1),
                  ...
                  Pe &&
                    ...
                    (p.scaleZ = 1)),
                  p.svg &&
                    ((p.x -= p.xOrigin - (p.xOrigin * W + p.yOrigin * Y)),
                    (p.y -= p.yOrigin - (p.xOrigin * q + p.yOrigin * X)));
              }
              for (l in ((p.zOrigin = v), p))
                m > p[l] && p[l] > -m && (p[l] = 0);
            }
            return (
              s &&
          ...
          je = function (e) {
            ...
            if (h) {
              ...
              if (
                (null != s.ox &&
                  ((x +=
                    (p = (s.oxp ? 0.01 * g * s.ox : s.ox) - g / 2) -
                    (p * o +
                      (f = (s.oyp ? 0.01 * v * s.oy : s.oy) - v / 2) * l)),
                  (T += f - (p * c + f * d))),
                _
                  ? (y +=
                      ", Dx=" +
                ...
                for (
                  ...
                  (C =
                    (i =
                      -1 !== (E = h[(S = te[_e])]).indexOf("px")
                        ? parseFloat(E)
                        : Q(this.t, S, parseFloat(E), E.replace(b, "")) ||
                          0) !== s[S]
                      ? 2 > _e
                        ? -s.ieOffsetX
                        : -s.ieOffsetY
                ...
                if (
                  ...
                  (c = 1),
                    ...
                    (P = k * I) &&
                      ...
                      (n *= g)),
                    (P = M * I) &&
                      ((_ = i * (g = Math.cos(P)) + s * (v = Math.sin(P))),
                      (y = r * g + a * v),
                      (l = c * v),
                      (u = h * v),
                      (s = i * -v + s * g),
        ...
        ((c = Me.prototype).x =
              ...
              parser: function (e, t, i, s, r, o, l) {
                ...
                if (
                  (l.display
                    ? ((h = U(e, "display")),
                      (b.display = "block"),
                      (c = Ne(e, n, !0, l.parseTransform)),
                      (b.display = h))
                    : (c = Ne(e, n, !0, l.parseTransform)),
                  (s._transform = c),
                  "string" == typeof T.transform && Ee)
                )
                  ((h = j.style)[Ee] = T.transform),
                    (h.display = "block"),
                    (h.position = "absolute"),
                    ...
                    null != T.xPercent &&
                      (d.xPercent = re(T.xPercent, c.xPercent)),
                    null != T.yPercent &&
                      (d.yPercent = re(T.yPercent, c.yPercent));
                  ...
                  if (
                    ...
                    if ("object" == typeof g) for (h in g) T[h] = g[h];
                    else T.rotation = g;
                  "string" == typeof T.x &&
                    -1 !== T.x.indexOf("%") &&
                    ((d.x = 0), (d.xPercent = re(T.x, c.xPercent))),
                    "string" == typeof T.y &&
                      -1 !== T.y.indexOf("%") &&
                      ((d.y = 0), (d.yPercent = re(T.y, c.yPercent))),
                    (d.rotation = ae(
                      "rotation" in T
                        ? T.rotation
                        : "shortRotation" in T
                    ...
                    (d.skewX =
                      null == T.skewX ? c.skewX : ae(T.skewX, c.skewX)),
                    (d.skewY =
                      null == T.skewY ? c.skewY : ae(T.skewY, c.skewY)),
                    (u = d.skewY - c.skewY) &&
                      ((d.skewX += u), (d.rotation += u));
                }
                for (
                  Pe &&
                    null != T.force3D &&
                    ((c.force3D = T.force3D), (m = !0)),
                    c.skewType = T.skewType || c.skewType || a.defaultSkewType,
                    (f =
                      c.force3D ||
                      c.z ||
                      c.rotationX ||
                ...
                return (
                  ...
                  c.svg &&
                    ...
                    ((v = c.xOffset),
                    (_ = c.yOffset),
                    Ie(e, se(p), d, T.svgOrigin, T.smoothOrigin),
                    (r = ge(
                      c,
                      "xOrigin",
                      (y ? c : d).xOrigin,
                      ...
                      ? ((m = !0),
                        ...
                        Pe
                          ? ((h = c.zOrigin),
                            ...
                            (r.xs0 = r.e =
                              p[0] + " " + (p[1] || "50%") + " 0px"),
                            ((r = new me(c, "zOrigin", 0, 0, r, -1, r.n)).b =
                              h),
                            (r.xs0 = r.e = c.zOrigin))
                          : (r.xs0 = r.e = p))
                      : se(p + "", c)),
                  m &&
                    (s._transformType =
                      (c.svg && xe) || (!f && 3 !== this._transformType)
                        ? 2
                        : 3),
                  r
                );
          ...
          be("borderRadius", {
            ...
            parser: function (e, t, i, r, a) {
              ...
              for (
                ...
                this.p.indexOf("border") && (T[l] = G(T[l])),
                  -1 !== (u = d = U(e, T[l], n, !1, "0px")).indexOf(" ") &&
                    ((d = u.split(" ")), (u = d[0]), (d = d[1])),
                  (h = c = o[l]),
                  (p = parseFloat(u)),
                  (_ = u.substr((p + "").length)),
                  (y = "=" === h.charAt(1))
                    ? ((f = parseInt(h.charAt(0) + "1", 10)),
                      (h = h.substr(2)),
                      (f *= parseFloat(h)),
                      (v = h.substr((f + "").length - (0 > f ? 1 : 0)) || ""))
                    : ((f = parseFloat(h)), (v = h.substr((f + "").length))),
                  "" === v && (v = s[i] || _),
                  v !== _ &&
                    ((b = Q(e, "borderLeft", p, _)),
                    (w = Q(e, "borderTop", p, _)),
                    "%" === v
                      ? ((u = (b / m) * 100 + "%"), (d = (w / g) * 100 + "%"))
                      : "em" === v
                      ? ((u = b / (x = Q(e, "borderLeft", 1, "em")) + "em"),
                        (d = w / x + "em"))
                      : ((u = b + "px"), (d = w + "px")),
                    y &&
                      ((h = parseFloat(u) + f + v),
                      (c = parseFloat(d) + f + v))),
                  (a = ve(E, T[l], u + " " + d, h + " " + c, !1, "0px", a));
              return a;
            },
            prefix: !0,
          ...
          be("backgroundPosition", {
            ...
            parser: function (e, t, i, s, r, a) {
              ...
              if (
                ...
                (h = U(e, "backgroundImage").replace(P, "")) &&
                "none" !== h
              ) {
                for (
                  o = g.split(" "),
                  ...
                  (d = -1 !== (g = o[c]).indexOf("%")) !==
                    ...
                    ((u =
                      0 === c
                        ? e.offsetWidth - F.width
                        : e.offsetHeight - F.height),
                    (o[c] = d
          ...
          be("backgroundSize", { defaultValue: "0 0", formatter: se }),
            ...
            parser: function (e, t, i, s, r, a) {
              ...
              return (
                9 > m
                  ...
                  : ((o = this.format(U(e, this.p, n, !1, this.dflt))),
                    (t = this.format(t))),
          ...
          be("border", {
            ...
            parser: function (e, t, i, s, r, a) {
              return this.parseComplex(
                e.style,
                this.format(
                  U(e, "borderTopWidth", n, !1, "0px") +
                    " " +
                    U(e, "borderTopStyle", n, !1, "solid") +
                    " " +
                    U(e, "borderTopColor", n, !1, "#000")
                ),
                this.format(t),
                r,
                a
        ...
        var Be = function (e) {
          ...
          100 === n &&
            ...
            -1 === s.indexOf("radient(") &&
            -1 === s.indexOf("oader(")
              ? (i.removeAttribute("filter"), (t = !U(this.data, "filter")))
              : ((i.filter = s.replace(T, "")), (t = !0))),
            t ||
              (this.xn1 && (i.filter = s = s || "alpha(opacity=" + n + ")"),
              -1 === s.indexOf("pacity")
                ? (0 === n && this.xn1) ||
                  (i.filter = s + " alpha(opacity=" + n + ")")
                : (i.filter = s.replace(w, "opacity=" + n)));
        };
        be("opacity,alpha,autoAlpha", {
          ...
          parser: function (e, t, i, s, r, a) {
            ...
            return (
              ...
              c &&
                1 === o &&
                "hidden" === U(e, "visibility", n) &&
                0 !== t &&
                (o = 0),
              W
                ? (r = new me(l, "opacity", o, t - o, r))
                : (((r = new me(l, "opacity", 100 * o, 100 * (t - o), r)).xn1 =
                    c ? 1 : 0),
                  (l.zoom = 1),
                  (r.type = 2),
          ...
          We = function (e) {
            if (((this.t._gsClassPT = this), 1 === e || 0 === e)) {
              ...
              for (var t = this.data, i = this.t.style; t; )
                t.v ? (i[t.p] = t.v) : He(i, t.p), (t = t._next);
              1 === e &&
        ...
        be("className", {
          parser: function (e, t, s, r, a, o, l) {
            var c,
              ...
              m = e.style.cssText;
            if (
              (((a = r._classNamePT = new me(e, s, 0, 0, a, 2)).setRatio = We),
              (a.pr = -11),
              (i = !0),
              (a.b = f),
              (d = Z(e, n)),
              ...
              for (
                ...
                (i = t[s]),
                  l[i] &&
                    (l[i].parse === o
                      ? (n = !0)
                      : (i = "transformOrigin" === i ? Ce : l[i].p)),
                  He(a, i);
            n &&
              (He(a, Ee),
              (r = this.t._gsTransform) &&
                (r.svg && this.t.removeAttribute("data-svg-origin"),
        ...
        for (
          be("clearProps", {
            parser: function (e, t, s, n, r) {
              return (
                ((r = new me(e, s, 0, 0, r, 2)).setRatio = qe),
                (r.e = t),
                (r.pr = -10),
                (r.data = n._tween),
                (i = !0),
        ...
        ((c = a.prototype)._firstPT =
          ...
          (c._onInitTween = function (e, t, o) {
            ...
            if (
              ...
              "string" == typeof t &&
                ...
                (T.cssText = g + ";" + t),
                (c = J(e, c, Z(e)).difs),
                !W && x.test(t) && (c.opacity = parseFloat(RegExp.$1)),
                (t = c),
                (T.cssText = g)),
              (this._firstPT = p =
                t.className
              ...
              for (
                ...
                m = m._next;
              (b = new me(e, "transform", 0, 0, null, 2)),
                this._linkCSSP(b, null, m),
                (b.setRatio = Ee ? Fe : je),
                (b.data = this._transform || Ne(e, n, !0)),
                (b.tween = o),
                (b.pr = -1),
                r.pop();
            }
                ...
                (o = l[a])
                  ...
                  : ((h = U(e, a, n) + ""),
                    ...
                    (g && E.test(p))
                      ? (g ||
                          (p =
                            ((p = ce(p)).length > 3 ? "rgba(" : "rgb(") +
                            p.join(",") +
                            ")"),
                        (i = ve(_, a, h, p, !0, "transparent", i, 0, r)))
                  ...
                  if (
                    ...
                    if (1 === n.type)
                      if (2 === (s = n.l))
                        ...
                        for (i = n.xs0 + t + n.xs1, s = 1; n.l > s; s++)
                          i += n["xn" + s] + n["xs" + (s + 1)];
                        n.t[n.p] = i;
                      }
                    else
          ...
          (c._enableTransforms = function (e) {
            (this._transform = this._transform || Ne(this._target, n, !0)),
              (this._transformType =
        ...
        (c._addLazySet = function (e, t, i) {
          ...
          (c._kill = function (t) {
            ...
            return (
              ...
              e.prototype._kill.call(this, r)
            );
          });
        var Xe = function (e, t, i) {
          var s, n, r, a;
          if (e.slice) for (n = e.length; --n > -1; ) Xe(e[n], t, i);
          else
            for (n = (s = e.childNodes).length; --n > -1; )
              (a = (r = s[n]).type),
                r.style && (t.push(Z(r)), i && i.push(r)),
                (1 !== a && 9 !== a && 11 !== a) ||
                  !r.childNodes.length ||
                  Xe(r, t, i);
        };
        return (
          (a.cascadeTo = function (e, i, s) {
            var n,
              r,
              a,
              o,
    ...
    (_gsScope._gsDefine.plugin({
      ...
      init: function (e, t) {
        ...
        var i,
          ...
          r,
          a,
          o = !0 === t.useRadians ? 2 * Math.PI : 360,
          l = 1e-6;
        for (i in t)
          "useRadians" !== i &&
            ((s = (a = (t[i] + "").split("_"))[0]),
            ...
            a.length &&
              (-1 !== (s = a.join("_")).indexOf("short") &&
                ...
                (r = 0 > r ? r + o : r - o),
              -1 !== s.indexOf("_cw") && 0 > r
                ? (r = ((r + 9999999999 * o) % o) - (0 | (r / o)) * o)
                : -1 !== s.indexOf("ccw") &&
                  r > 0 &&
                  (r = ((r - 9999999999 * o) % o) - (0 | (r / o)) * o)),
            (r > l || -l > r) &&
              (this._addTween(e, i, n, n + r, i),
              this._overwriteProps.push(i)));
        return !0;
      },
      set: function (e) {
  ...
  (function (e, t) {
    ...
    if (!i.TweenLite) {
      var s,
        ...
        m = function (t, s, n, r) {
          ...
          (this.check = function (o) {
            for (var c, d, u, h, p, g = s.length, v = g; --g > -1; )
              (c = f[s[g]] || new m(s[g], [])).gsClass
                ? ((a[g] = c.gsClass), v--)
                : o && c.sc.push(this);
            if (0 === v && n)
              for (
                u = (d = ("com.greensock." + t).split(".")).pop(),
                  h = l(d.join("."))[u] = this.gsClass = n.apply(n, a),
                  r &&
                    ((i[u] = h),
      ...
      var _ = [0, 0, 1, 1],
        ...
        x = (b.register = function (e, t, i, s) {
          for (
            ...
            for (
              r = l[d],
                n = s ? v("easing." + r, null, !0) : c.easing[r] || {},
                a = u.length;
              --a > -1;
      ...
      for (
        (r = b.prototype)._calcEnd = !1,
          r.getRatio = function (e) {
            ...
            var t = this._type,
              i = this._power,
              s = 1 === t ? 1 - e : 2 === t ? e : 0.5 > e ? 2 * e : 2 * (1 - e);
            return (
              1 === i
                ? (s *= s)
                : 2 === i
      ...
      ((r = T.prototype).addEventListener = function (e, t, i, s, n) {
        ...
        for (
          ...
          (r = c[l]).c === t && r.s === i
            ? c.splice(l, 1)
            : 0 === d && n > r.pr && (d = l + 1);
        c.splice(d, 0, { c: t, s: i, up: s, pr: n }),
          this !== a || o || a.wake();
      }),
      ...
      var E = e.requestAnimationFrame,
        ...
        P = C();
      for (n = (s = ["ms", "moz", "webkit", "o"]).length; --n > -1 && !E; )
        (E = e[s[n] + "RequestAnimationFrame"]),
          (S =
            e[s[n] + "CancelAnimationFrame"] ||
            e[s[n] + "CancelRequestAnimationFrame"]);
      v("Ticker", function (e, t) {
        ...
        T.call(c),
          ...
          (c.sleep = function () {
            null != n &&
              (p && S ? S(n) : clearTimeout(n),
              (s = h),
              (n = null),
              c === a && (o = !1));
          }),
          (c.wake = function () {
            null !== n ? c.sleep() : c.frame > 10 && (P = C() - f + 5),
              (s =
                0 === i
                  ? h
                  : p && E
          ...
          (c.fps = function (e) {
            return arguments.length
              ? ((r = 1 / ((i = e) || 60)), (l = this.time + r), void c.wake())
              : i;
          }),
          (c.useRAF = function (e) {
        ...
        ((r = c.Ticker.prototype = new c.events.EventDispatcher()).constructor =
          c.Ticker);
      ...
      (a = M.ticker = new c.Ticker()),
        ((r = M.prototype)._dirty = r._gc = r._initted = r._paused = !1),
      ...
      k(),
          ...
          if (this._timeline) {
            ...
            this._gc && this._enabled(!0, !1),
              (this._totalTime !== e || 0 === this._duration) &&
                (I.length && $(), this.render(e, t, !1), I.length && $());
          }
          return this;
        }),
        ...
        (r.timeScale = function (e) {
          ...
          if (
            ((e = e || d), this._timeline && this._timeline.smoothChildTiming)
          ) {
      ...
      ((r = O.prototype = new M()).constructor = O),
        (r.kill()._gc = !1),
      ...
      var A = v(
          ...
          function (t, i, s) {
            ...
            if (
              ((this._overwrite = l =
                null == l
                  ? Y[A.defaultOverwrite]
                  : "number" == typeof l
                  ? l >> 0
                  : Y[l]),
              (o || t instanceof Array || (t.push && p(t))) &&
                "number" != typeof t[0])
            )
              for (
                this._targets = a = u(t),
                ...
                (r = a[n])
                  ? "string" != typeof r
                    ? r.length &&
                      ...
                      : ((this._siblings[n] = U(r, this, !1)),
                        1 === l &&
                          this._siblings[n].length > 1 &&
                          K(r, this, null, 1, this._siblings[n]))
                    : "string" == typeof (r = a[n--] = A.selector(r)) &&
                      a.splice(n + 1, 1)
                  : a.splice(n--, 1);
            else
              (this._propLookup = {}),
                ...
                1 === l &&
                  ...
                  K(t, this, null, 1, this._siblings);
      ...
      var I = [],
        ...
        z = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
        R = function (e) {
          for (var t, i = this._firstPT, s = 1e-6; i; )
        ...
        N = function (e, t, i, s) {
          ...
          for (
            ...
            (d = r[o]),
              (p += (c = t.substr(h, t.indexOf(d, h) - h)) || !o ? c : ","),
              (h += c.length),
          ...
          return (
            "number" !== d &&
              ...
              "string" == typeof c && (a || isNaN(c))
                ...
                : u || (h.c = parseFloat(s) - parseFloat(c) || 0)),
            h.c
        ...
        (M._updateRoot = A.render =
          function () {
            ...
            if (
              ...
              for (i in ((G = a.frame + (parseInt(A.autoSleep, 10) || 120)),
              H)) {
      ...
      var U = function (e, t, i) {
        ...
        Z = function (e, t, i) {
          for (
            var s = e._timeline, n = s._timeScale, r = e._startTime;
            s._timeline;
          ...
          return (r /= n) > t
            ? r - t
            : (i && r === t) || (!e._initted && 2 * d > r - t)
            ? d
            : (r += e.totalDuration() / e._timeScale / n) > t + d
            ? 0
            : r - t - d;
        };
      (r._init = function () {
        ...
        if (
          (t && A._onPluginEvent("_onInitAllProps", this),
          a &&
            (this._firstPT ||
        ...
        (r._initProps = function (t, i, s, n) {
          ...
          this.vars))
            if (((d = this.vars[r]), q[r]))
              d &&
                (d instanceof Array || (d.push && p(d))) &&
                -1 !== d.join("").indexOf("{self}") &&
                (this.vars[r] = d = this._swapSelfInParams(d, this));
            else if (
              B[r] &&
              (l = new B[r]())._onInitTween(t, this.vars[r], this)
            ) {
              for (
                this._firstPT = c =
                  {
          ...
          return n && this._kill(n, t)
            ? this._initProps(t, i, s, n)
            : this._overwrite > 1 &&
              this._firstPT &&
              s.length > 1 &&
              K(t, this, i, this._overwrite, s)
            ? (this._kill(i, t), this._initProps(t, i, s, n))
            : (this._firstPT &&
                ((!1 !== this.vars.lazy && this._duration) ||
                  (this.vars.lazy && !this._duration)) &&
                (D[t._gsTweenID] = !0),
          ...
          if (e >= l)
            (this._totalTime = this._time = l),
              ...
              0 === l &&
                (this._initted || !this.vars.lazy || i) &&
                (this._startTime === this._timeline._duration && (e = 0),
                (0 === e || 0 > c || (c === d && "isPause" !== this.data)) &&
                  c !== e &&
                  ((i = !0), c > d && (n = "onReverseComplete")),
                (this._rawPrevTime = a = !t || e || c === e ? e : d));
          else if (1e-7 > e)
            (this._totalTime = this._time = 0),
              (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
              (0 !== o || (0 === l && c > 0)) &&
          ...
          if (this._time !== o || i) {
            ...
            this._onUpdate &&
              (0 > e &&
                ...
                -1e-4 !== e &&
                this._startAt.render(e, t, i),
              t || ((this._time !== o || s) && this._callback("onUpdate"))),
              n &&
                (!this._gc || i) &&
                (0 > e &&
                  this._startAt &&
        ...
        (r._enabled = function (e, t) {
          ...
          return (
            ...
            !(!this._notifyPluginsOfEnabled || !this._firstPT) &&
              A._onPluginEvent(e ? "_onEnable" : "_onDisable", this)
          );
        }),
        (A.to = function (e, t, i) {
          return new A(e, t, i);
        ...
        (A.getTweensOf = function (e, t) {
          ...
          if (
            ...
            (p(e) || L(e)) && "number" != typeof e[0])
          ) {
            for (i = e.length, s = []; --i > -1; )
              s = s.concat(A.getTweensOf(e[i], t));
            for (i = s.length; --i > -1; )
              for (r = s[i], n = i; --n > -1; ) r === s[n] && s.splice(i, 1);
          } else
            for (i = (s = U(e).concat()).length; --i > -1; )
        ...
        (A.killTweensOf = A.killDelayedCallsTo =
          function (e, t, i) {
            ...
            for (var s = A.getTweensOf(e, t), n = s.length; --n > -1; )
              s[n]._kill(i, e);
          });
      var J = v(
        "plugins.TweenPlugin",
      ...
      if (
        ...
        (J.activate = function (e) {
          for (var t = e.length; --t > -1; )
            e[t].API === J.API && (B[new e[t]()._propName] = e[t]);
          return !0;
        }),
        (g.plugin = function (e) {
